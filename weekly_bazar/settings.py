"""
Django settings for weekly_bazar project.
...
SECRET_KEY = 'django-insecure-^i$1gx57jfzges_rjglsk_vhb6u#%m!d-^@58tmarbit1*08uk'
...
ROOT_URLCONF = 'weekly_bazar.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            ...
            'builtins': [
                'user.templatetags.tag'
            ],
        },
    },
]

WSGI_APPLICATION = 'weekly_bazar.wsgi.application'
